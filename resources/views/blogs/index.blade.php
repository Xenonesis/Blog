        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
            <div class="text-center">
                ...
                <div class="grid grid-cols-3 gap-8 max-w-md mx-auto mt-12" data-aos="fade-up" data-aos-delay="300">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-white">{{ $blogs->total() ?? 0 }}+</div>
                        <div class="text-white/80">Articles</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-white">{{ $categories->count() ?? 0 }}+</div>
                            ...
                            <div class="flex flex-wrap gap-2">
                                @forelse($tags->take(15) as $tag)
                                    <a href="{{ route('blogs.tag', $tag->slug) }}" 
                                       class="badge bg-gray-100 hover:bg-primary-100 text-gray-700 hover:text-primary-700 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-primary-900 dark:hover:text-primary-300 transition-colors">
                                        #{{ $tag->name }}
                                    </a>
                                @empty
