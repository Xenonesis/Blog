...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">Create a new blog post with rich content</p>
    </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_hidden" value="1" 
                                           class="mr-2 text-blue-600" {{ old('is_hidden') ? 'checked' : '' }}>
                                    <span class="text-sm text-gray-700 dark:text-gray-300">Hide from public</span>
                                </label>
                            </div>
                        </div>
