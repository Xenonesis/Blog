...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center">
            <a href="{{ route('admin.tags.index') }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 mr-4">
                ← Back to Tags
            </a>
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Tag</h1>
                <p class="mt-2 text-gray-600 dark:text-gray-400">Update tag information</p>
            </div>
        </div>
    </div>
